...
from legacy.database import get_best_teams, update_general_table, create_general_table, generate_teams_table, check_team_stats, \
    get_teams, update_team
from legacy.leagues import league_simulation, select_league, select_teams_from_league, cup_simulation
from legacy.matches import play_european_cup
